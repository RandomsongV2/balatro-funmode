--from cryptid
function Funmode.forcetrigger_vanilla(card, context)
    local results = {jokers = {}}
	if not card then
		return results
	end
    --todo optimize this into structure like this
    --  {"Joker" = (function() return {jokers = {mult = card.ability.mult, card = card}} end),
    --   "Greedy Joker" = (function() return {jokers = {mult = card.ability.extra.s_mult, card = card}} end)}
